...
function Header(props) {
  ...
  return (
    <header className={styles.header}>
        ...
        <Link to="/" className={styles.display} >
                <figure className={styles.logoBtn}>
            ...
            <nav>
                <div className={styles.firebaseInfo}>
                {
                    ...
                    <>
                        <ul className={styles.firebaseContent}> 
                            <li className={styles.navLink}>
                                Hi, {props.userState.user.displayName}
                            </li> 
                            <li className={styles.navLink} >
                            ...
                            Logout
                                        ...
                                        :
                    <ul>
                        <li className={styles.navLinkOut} onClick={login}>
                            Login
                        </li>
                    </ul>
        ...
        <div className= {hamburgerMenu ? styles.active : styles.hamburgerMenu} >
            <ul className={styles.hamburgerMenuItems} onClick={showHamburgerMenu} >
                ...
                <Link to='/ViewStatements'> 
                    <li className={styles.menuItems}>View Statements</li></Link> 
                <Link to='/CreateProposal'>
                    <li className={styles.menuItems}>Create a Proposal</li>
                </Link> 
